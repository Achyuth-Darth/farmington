      ...
      <script>
        ...
        <div>
          <nav class="navbar navbar-expand-lg navbar-light gray" style="height: 55px;">
            <a class="navbar-brand" href="#"><img src="{{url('assets/images/farm.png')}}" alt="Smiley face" height="60" width="60"></a>
	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<div class="modal-header">
				<div class="avatar">
					<img src="{{url('assets/images/farm.png')}}" alt="Avatar">
				</div>				
				<h4 class="modal-title">Farmington<br>LOGIN</h4>	
...
<footer class="page-footer font-small blue">
    ...
    <div class="footer-copyright text-center py-3">© 2020 Copyright:
      <a href="https://mdbootstrap.com/education/bootstrap/"> Farmington.com</a>
    </div>
    <!-- Copyright -->
